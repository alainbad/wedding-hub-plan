  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-secondary/30 px-4 py-12">
      <Link to="/" className="mb-8 flex items-baseline gap-1.5">
        <span className="font-serif text-3xl font-semibold tracking-tight text-primary">WeddingHub</span>
      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          By continuing you agree to list your business in accordance with our guidelines.
        </p>
      </div>
